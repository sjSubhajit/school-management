...
function getResultSections() {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $("div .sections .current").html(
        $("div .sections .list li:first").html()
      );
...
function getResultExamTypes() {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $("div .exam_types .current").html(
        $("div .exam_types .list li:first").html()
      );
